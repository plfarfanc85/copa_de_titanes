...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header"><?php echo $model->name; ?> <small>Resumen y Gestión</small></h1>
	...
	<div class="col-md-6 ui-sortable">
		<div class="panel panel-<?php echo ($key%2==0)?'info':'success' ?>" data-sortable-id="ui-widget-16">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><?php echo $value->name ?> - <?php echo date('d-m h:i',strtotime($value->date)) ?> - <?php echo $value->getStateLabel() ?></h4>
                <?php /*<h4 class="panel-title"><?php echo $value->name ?> - <?php echo substr($value->date,-8,5) ?> - <?php echo $value->getStateLabel() ?></h4> */?>
            </div>
            ...
            <?php if($value->state == 2): //si el partido esta en juego, formulario de registro de marcador ?> 
                <?php $this->renderPartial("_form_score",array('value'=>$value,'form_arr'=>$form_arr,'score'=>$score)); ?>
           	<?php else: ?>
            	<h6 class="text-center">	
                <?php foreach ($value->tournamentMatchDetail as $key2 => $value2): ?>
                	<?php if($key2==0): ?>
                		<?php echo $value2->player->getNames() ?> <span class="badge badge-warning badge-square"><?php echo $value2->point ?></span><br><strong>vs</strong><br>
                	<?php else: ?>
                		<?php echo $value2->player->getNames() ?><span class="badge badge-warning badge-square"><?php echo $value2->point ?></span>
                	<?php endif; ?>	
                <?php endforeach; ?>
                </h6>
            <?php endif; ?>	

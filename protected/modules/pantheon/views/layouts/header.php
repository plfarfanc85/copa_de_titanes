<div id="header" class="header navbar navbar-default navbar-fixed-top">
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			<li>
				<form class="navbar-form full-width" method="post" action="<?php echo Yii::app()->createUrl('/pantheon/tournament/index'); ?>">
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Documento del usuario" name="search" />
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            ...
                            <div class="media-body">
                                <h6 class="media-heading">Bievenido Usuario Administrador</h6>
			...
			<li class="dropdown navbar-user">
				...
				<ul class="dropdown-menu animated fadeInLeft">
					...
					<li class="divider"></li>
					<li><?php echo CHtml::link('Log Out',array('/pantheon/rrhh/logout')); ?></li>
				</ul>
			</li>
		</ul>

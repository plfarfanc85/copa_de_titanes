...
<ol class="breadcrumb pull-right">
	...
	<!--<li class="active">'Partidos ganados'</li>-->
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Partidos Jugados <small>Lista de partidos</small></h1>
	...
	<div class="col-md-6 ui-sortable">
		<div class="panel panel-warning" data-sortable-id="ui-widget-16">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><?php echo $value->tournamentGroup->phase->session->tournament->name.' - '.$value->name ?> - <?php echo $value->date ?> - <?php echo $value->getStateLabel() ?></h4>
            </div>

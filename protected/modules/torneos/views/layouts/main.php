...
<!--<![endif]-->
	<head>
		...
		<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/jquery-jvectormap/jquery-jvectormap.css" rel="stylesheet" />
	...
	<body>
		...
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/jquery-jvectormap/jquery-jvectormap.min.js"></script>

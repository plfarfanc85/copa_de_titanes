...
<!--<![endif]-->
	<head>
		...
		<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet" media='print' />
		<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" />
		...
		<!-- ORANGE -->
		<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/css/theme/black.css" rel="stylesheet" />
	...
	<body>
		...
		<!-- ================== BEGIN BASE JS ================== -->
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/fullcalendar/lib/moment.min.js"></script>
		...
		<!-- ================== BEGIN PAGE LEVEL JS ================== -->
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/fullcalendar/fullcalendar.min.js"></script>
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/js/calendar.demo.min.js"></script>

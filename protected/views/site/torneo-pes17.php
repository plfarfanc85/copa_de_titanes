...
<!-- ================ -->
<div class="banner">
	<div class="fixed-image section light-translucent-bg" style="background-image:url('<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/Torneo-PES17-banner.jpg');">
		<div class="container">
		<div class="space-top"></div>
		<h1>Torneo de PES 18</h1>
		<div class="separator-2"></div>
		<p class="lead">La calidad del mundialmente conocido gameplay ha sido mejorada meticulosamente <br class="hidden-xs hidden-sm"> para recrear la autenticidad del fantástico juego, incluyendo una velocidad de juego más realista.  <br class="hidden-xs hidden-sm"> Juega nuestro torneo y conviertete en uno de nuestros Dioses.</p>
		</div>
	</div>
</div>
<!-- banner end -->
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Torneo de PES 18</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="main col-md-12">
				...
				<!-- page-title start -->
				<!-- ================ -->
				<h1 class="page-title text-center">Torneo de PES 18</h1>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="contact-form">
							<form role="form" method="post" action="<?php echo $this->createUrl('/site/torneoPes'); ?>">
						...
						<div class="tab-pane active" id="pill-1">
							...
							<div >
								<div >
									<p>Pre inscríbete en nuestro <strong>Torneo de PES 18</strong> para mantenerte al tanto de las fechas y lugar donde se llevara a cabo. Ademas se el primero de enterarte de muchas sorpresas más.</p>
					...
					<div class="col-md-6">
						...
						<img class="animated fadeInUpSmall" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/services-PES2018.jpg" alt="Torneo PES17">
					</div>
				</div>

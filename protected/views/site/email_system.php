                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        <a href="index.html"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/logo.png" /></a>
                                                    </td>
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td class="text-right valign-middle">
                                                        <span class="template-label">Bienvenida Email</span>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4>Bienvenido a CupsOfGods.</h4>
                                                    <p class="m-b-5">Para registrate a nuestro primer torneo de Fifa, solo debes seguir los siguientes pasos:</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="panel">
                                                    <ul>
                                                      <li>
                                                          1- Registrarte en la plataform de torneos: 
                                                          <br><a href="javascript:;">http://www.cupsofgods.com/tournament/user/register</a>
                                                      </li>
                                                      <li>
                                                          2- Realizar el pago de inscripción (Te llegará un correo con los datos bancarios).
                                                      </li>
                                                      <li>
                                                          3- Reportar el pago (Te llegará un correo confirmando tu reporte de pago):
                                                          <br><a href="javascript:;">http://www.cupsofgods.com/tournament/user/registerPago</a>
                                                      </li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p class="m-t-15 last">Desde el momento en que te preinscribes, guardas un cupo al torneo por un plazo de 2 dìas. Despues de este tiempo tendras que contactarte al número 3013498007, para validar disponiblidad de cupo.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h4>Plataforma de torneos</h4>
                                                    <p>
                                                        Aquí podras dar seguimiento en vivo a los torneos, ver datos estadisticos de tu desempeño, y mucho más. Pronto podrás tener acceso a la plataforma, estes pendiente de tu correo!!
                                                    </p>
                                                    <p>
                                                        <a href="index.html"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/product/product-preview.jpg" /></a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>

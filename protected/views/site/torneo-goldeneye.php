...
<!-- ================ -->
<div class="banner">
	<div class="fixed-image section light-translucent-bg" style="background-image:url('<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/Torneo-GE-banner.jpg');">
		<div class="container">
		<div class="space-top"></div>
		<h1>Torneo de GoldenEye</h1>
		<div class="separator-2"></div>
		<p class="lead">Quieres acabar con todos de un disparo de la Golden Gun ? <br class="hidden-xs hidden-sm"> Esta es la oportunidad para hacerlo y ganar excelentes premios. <br class="hidden-xs hidden-sm"> Cups of Gods organiza el primer torneo de uno de los clásicos en las consolas de video juegos.</p>
		</div>
	</div>
</div>
<!-- banner end -->
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Torneo de GoldenEye</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="main col-md-12">
				...
				<!-- page-title start -->
				<!-- ================ -->
				<h1 class="page-title text-center">Torneo de GoldenEye</h1>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="contact-form">
							<form role="form" method="post" action="<?php echo $this->createUrl('/site/torneoGoldenEye'); ?>">
						...
						<div class="tab-pane active" id="pill-1">
							...
							<div >
								<div >
									<p>Pre inscríbete en nuestro <strong>Torneo de GoldenEye</strong> para mantenerte al tanto de las fechas y lugar donde se llevara a cabo. Ademas se el primero de enterarte de muchas sorpresas más.</p>
					...
					<div class="col-md-6">
						...
						<img class="animated fadeInUpSmall" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/services-ge.png" alt="Torneo PES17">
					</div>
				</div>

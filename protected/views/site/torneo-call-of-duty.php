...
<!-- ================ -->
<div class="banner">
	<div class="fixed-image section light-translucent-bg" style="background-image:url('<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/Torneo-COD-banner.jpg');">
		<div class="container">
		<div class="space-top"></div>
		<h1>Torneo de Call Of Duty</h1>
		<div class="separator-2"></div>
		<p class="lead">Eres terrorista o perteneces al grupo elite, demuestra tu <br class="hidden-xs hidden-sm">estrategia militar en el primer torneo organizado por Cups of Gods..</p>
		</div>
	</div>
</div>
<!-- banner end -->
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Torneo de Call Of Duty</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="main col-md-12">
				...
				<!-- page-title start -->
				<!-- ================ -->
				<h1 class="page-title text-center">Torneo de Call Of Duty</h1>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="contact-form">
							<form role="form" method="post" action="<?php echo $this->createUrl('/site/torneoCallOfDuty'); ?>">
								
								<div class="form-group has-feedback">
									<label for="email">Email*</label>
									<input type="email" class="form-control" id="email" name="email" placeholder="">
									<input type="hidden" name="game" value="4">
						...
						<div class="tab-pane active" id="pill-1">
							...
							<div >
								<div >
									<p>Pre inscríbete en nuestro <strong>Torneo de Call Of Duty</strong> para mantenerte al tanto de las fechas y lugar donde se llevara a cabo. Ademas se el primero de enterarte de muchas sorpresas más.</p>
					...
					<div class="col-md-6">
						...
						<img class="animated fadeInUpSmall" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/services-cod.png" alt="Torneo PES17">
					</div>
				</div>
